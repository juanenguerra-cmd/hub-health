    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Implemented outputs</CardTitle>
              <CardDescription>Capabilities currently backed by code paths in this release.</CardDescription>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Planned / intended outputs</CardTitle>
              <CardDescription>Roadmap ideas not currently generated by the app runtime.</CardDescription>
            </CardHeader>
            <CardContent className="pt-0">
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>Advanced cross-period QAPI trend analytics with automated narrative write-ups.</li>
              </ul>
            </CardContent>
          </Card>
        </div>
